...
//				openWarnDialog(mActivity, "파일 전송에 실패했습니다.");
				Toast.makeText(CheckListActivity.this, "파일 전송에 실패했습니다.", Toast.LENGTH_LONG).show();
			}else{
//				openWarnDialog(mActivity, "파일 전송 성공");
				if("VPNFAIL".equals(sendCheckFile)){
					...
					Toast.makeText(CheckListActivity.this, "파일 전송에 실패했습니다.\n message:Fail("+sendCheckFile+")", Toast.LENGTH_LONG).show();
					...
					Toast.makeText(CheckListActivity.this, "파일 전송 성공", Toast.LENGTH_LONG).show();
				}else{
