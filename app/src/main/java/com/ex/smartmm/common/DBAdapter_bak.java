...
/*	public Cursor select_uptBMCJBGBM(String jangbicode){
	...
	/** 점검목록 선택 삭제 **/
	public Cursor deleteJBHistoryOne_Kyoryang(String date) {
		Log.d(TAG, "deleteJBHistoryOne_Kyoryang()~!");
		getSqlite().beginTransaction();
	...
	/** 점검목록 전부 삭제  **/
	public Cursor deleteJBHistoryKyoRyang() {
		getSqlite().beginTransaction();
